  ...
  describe('fromLog', () => {
    it('should decode valid docked event log from real blockchain data', () => {
      const log: Log = {
        ...
        transactionHash: '0xb4231e80752dac59d01480454fe85cde374ea087176158ba0ac8315aecf3fde0' as `0x${string}`,
        transactionIndex: 0,
        blockHash: '0x23820c2a5de498bc0c87469392eac0c456ce3712ae3872cd32055b9a17a405c7' as `0x${string}`,
        logIndex: 0,
        removed: false,
      }
      ...
      expect(event.strategyHash.toString()).toBe('0xfed4c945f2dc5747956337cf623dceacca130714540e70742e63456d3daf2400')
    })
    ...
    it('should decode valid docked event log', () => {
      const log: Log = {
        ...
        topics: [
          DockedEvent.TOPIC.toString() as `0x${string}`,
        ],
