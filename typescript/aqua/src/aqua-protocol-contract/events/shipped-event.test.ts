  ...
  describe('fromLog', () => {
    it('should decode valid shipped event log', () => {
      const log: Log = {
        ...
        transactionHash: '0x3643966559066142bd0ed23dd9f7834087c7c7a95930219a59924c37b9e4a1bc' as `0x${string}`,
        transactionIndex: 0,
      ...
      expect(event.strategyHash.toString()).toBe('0x2d142ba44ee9104f8cd702bfe7520e64eb8531c5e4e4ded80c6a93cf5a3d113e')
      expect(event.strategy.toString().startsWith('0x')).toBe(true)
      expect(event.strategy.toString()).toBe('')
    })
    ...
    it('should throw on missing data', () => {
      const log: Log = {
        ...
        topics: [
          ShippedEvent.TOPIC.toString() as `0x${string}`,
        ],
